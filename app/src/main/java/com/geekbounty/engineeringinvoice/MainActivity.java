...
//        View createPdf2 = findViewById(R.id.create_pdf2);

//     a

//        createPdf2.setOnClickListener(new View.OnClickListener() {
//            @Override
...
//        });
    ...
    public void createPdf() throws IOException {
        ...
        String outputPath = Environment.getExternalStorageDirectory()+"/newSample4.pdf"; //Specify the path where the document will be stored
        ...
        try {
            if(Build.VERSION.SDK_INT >= 23){
                if(checkPermission()){
                    ...
                    Chunk l1 = new Chunk("A. Top Soil for Preservation                    115              Sq.M          120           13800", listFont);
