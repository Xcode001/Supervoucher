...
public class ElectricalServicesActivity extends AppCompatActivity implements TitleDialog.TitleDialogListener{

    private static final String TAG = ElectricalServicesActivity.class.getSimpleName() ;
    private static final int PERMISSION_REQUEST_CODE = 100;
    EditText electricalAmount;
    TextView electrical_servicesTitle;
    String elec_servicesTitle;
    int electAmount;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        electricalAmount = findViewById(R.id.electricalAmount);
        electrical_servicesTitle = findViewById(R.id.electrical_servicesTitle);
    }

    //Generates the pdf Document
    public void createPdf() throws IOException {
        Document document = new Document();   //Creates a Document object
        String outputPath = Environment.getExternalStorageDirectory()+"/"+ elec_servicesTitle+ ".pdf"; //Specify the path where the document will be stored
        ...
        try {
            if(Build.VERSION.SDK_INT >= 23){
                if(checkPermission()){
                    ...
                    Chunk mOrderIdChunk = new Chunk("ELEMENT 10: ELECTRICAL SERVICES\n\n", mOrderIdFont);
                    ...
                    Chunk mSubOrderIdChunk2 = new Chunk("ELECTRICAL\n\n", mSubOrderIdFont2);
...
//
    ...
    private boolean checkPermission() {
        int result = ContextCompat.checkSelfPermission(ElectricalServicesActivity.this, android.Manifest.permission.WRITE_EXTERNAL_STORAGE);
    ...
    private void requestPermission() {
        ...
        if (ActivityCompat.shouldShowRequestPermissionRationale(ElectricalServicesActivity.this, android.Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
            Toast.makeText(ElectricalServicesActivity.this, "Write External Storage permission allows us to do store images. Please allow this permission in App Settings.", Toast.LENGTH_LONG).show();
        } else {
            ActivityCompat.requestPermissions(ElectricalServicesActivity.this, new String[]{android.Manifest.permission.WRITE_EXTERNAL_STORAGE}, PERMISSION_REQUEST_CODE);
        }
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()){
            ...
            case R.id.generate_invoice:
                elec_servicesTitle = electrical_servicesTitle.getText().toString().trim();
                if(elec_servicesTitle.isEmpty()){
    ...
    private void getValues() {
        try {
            electAmount = Integer.parseInt(electricalAmount.getText().toString().trim());
    ...
    public void applyTitle(String title) {
        electrical_servicesTitle.setText(title);
    }
}
